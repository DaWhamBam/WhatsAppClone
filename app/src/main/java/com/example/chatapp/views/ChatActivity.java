...
public class ChatActivity extends AppCompatActivity {
    ...
    private List<ChatMassage> messagesList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myViewModel.getMessagesLiveData(groupName).observe(this, new Observer<List<ChatMassage>>() {
            @Override
            public void onChanged(List<ChatMassage> chatMassages) {

                messagesList = new ArrayList<>();
                messagesList.addAll(chatMassages);
